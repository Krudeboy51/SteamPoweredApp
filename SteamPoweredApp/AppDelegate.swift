...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate {
    ...
    var mSVC: UISplitViewController!


    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        // Override point for customization after application launch.
        mSVC = (UIStoryboard(name: "Main", bundle: nil).instantiateViewControllerWithIdentifier("mSVC") as? UISplitViewController)!
        mSVC.delegate = self
        mSVC.preferredDisplayMode = UISplitViewControllerDisplayMode.AllVisible
        
        let containerVC : ContainerViewController = ContainerViewController()
        containerVC.setEmbeddedVC(mSVC)
